            ...
            >
              ...
              {p.variants && p.variants.length > 0 ? (
                <div style={{ margin: "8px 0" }}>
                  <p style={{ margin: "0 0 6px 0", fontSize: "14px", fontWeight: "bold", color: "#333" }}>
                  ...
                  <div style={{ 
                    ...
                    {p.variants.slice(0, 3).map((variant, index) => (
                      <div key={index} style={{ 
                        display: "flex", 
                ...
                <div style={{ margin: "8px 0", fontSize: "14px" }}>
                  <p style={{ margin: "2px 0" }}><strong>Size:</strong> {p.psize || "N/A"}</p>
                  <p style={{ margin: "2px 0" }}><strong>Color:</strong> {p.pcolor || "N/A"}</p>
                  <p style={{ margin: "2px 0" }}><strong>Stock:</strong> {p.quantity || 0}</p>
                </div>
              )}

              <p style={{ color: "#777", fontSize: "13px", margin: "8px 0 0 0" }}>{p.pdescription}</p>
            </div>
          ))}
        </div>
      </div>
